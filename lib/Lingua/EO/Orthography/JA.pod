...
Lingua::EO::Orthography::JA - Japanese (JA) translation of Lingua::EO::Orthography / 日本語訳
...
この文書はL<Lingua::EO::Orthography|Lingua::EO::Orthography>のバージョンC<0.01>について記述しています。
