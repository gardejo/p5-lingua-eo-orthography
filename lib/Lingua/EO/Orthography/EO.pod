...
L<Lingua::EO::Orthography::EO|Lingua::EO::Orthography::EO> (Ĉi tiu dokumento)
...
(eo: interfaco por aplikaprogramo, en: Application Programming Interface)
eble estas ŝanĝata.
...
Vi devas uzi la ortografion hodiaŭ krom se estas ia speciala motivo
ĉar Unikodo sufiĉe disvastiĝas.
Perl 5.8.1 aŭ pli malfrua ankaŭ manipulas ĝin ĝuste.

Mi rekomendas ke mi manipulas UTF-8 flagata ĉeno en ĉie en la via programo kaj
...
I inkluzivas ekzemplon en la distribuaĵo.
...
kiu estas konfuzata sin kaj surogata grafismo.
...
Vidu RFC 2396 kaj 3986 por URI, kaj RFC 5321 kaj 5322 por adreso de retpoŝto.
...
Mi estos avizata, kaj poste vi estos aŭtomate avizata de plibonstatiĝo
